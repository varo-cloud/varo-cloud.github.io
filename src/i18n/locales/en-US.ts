export default {
  ...
  pages: {
    ...
    billing: {
      ...
      bonusSectionTitle: 'Bonus lots',
      bonusSectionHint: 'Bonus cannot be withdrawn or refunded. It is spent before Cash and expires automatically.',
      bonusEmpty: 'No Bonus yet.',
      bonusRemaining: '{amount} remaining',
    ...
    seedCreator: {
      ...
      steps: {
        ...
        bonus: 'Get $20 Bonus when approved',
        invite: 'Share your invite link',
        winner: 'First qualifying friend unlocks $10 / $10',
      },
      campaign: {
        spots: 'Approved / cap',
      ...
      status: {
        submitted: 'Under review. You will receive $20 Bonus and an invite link if approved.',
      ...
      ended: {
        ...
        creatorBonusClaimed: 'Creator Bonus $20 claimed',
        inviteRewardClaimed: 'Invite reward $10 claimed',
      ...
      approved: {
        ...
        lead: 'Your exclusive invite is live. The first friend who completes a single top-up ≥ $10 within 3 days becomes the Winner.',
        rankLabel: 'Rank',
        rankValue: '#{rank}',
        bonusLabel: 'Creator Bonus',
        bonusClaimed: '$20 · Claimed',
      ...
      seo: {
        ...
        description:
          'Become a Varo Seed Creator: verify social accounts for $20 Bonus, then invite a friend to unlock $10 each.',
      },
    },
    invite: {
      eyebrow: 'Friend Invitation',
      title: 'You’re joining through a friend',
      lead: 'Sign up and complete a first single top-up of ≥ $10 within 3 days for a chance to become the only Winner.',
      steps: {
        register: 'Register on Varo.cloud',
        bind: 'Auto-bind invitation',
        topup: 'Top up ≥ $10 within 3 days',
        reward: 'Winner: +$10 each',
      },
      ...
      waitingRules: [
        'After binding, complete a first single top-up of ≥ $10 within 3 days.',
        'Split top-ups do not count — one payment must meet the threshold.',
        'Each inviter has only one Winner slot, awarded to the first qualifier.',
        'If you become the Winner, you and your inviter each receive $10 Bonus.',
        'Bonus is non-withdrawable and non-refundable; valid for 14 days after claim.',
      ],
      ...
      noRewardLead:
        'You met the top-up requirement, but the only $10 slot for this invite was already claimed by an earlier qualifier.',
      ...
      seo: {
        ...
        description: 'Join Varo with a Seed Creator invite and earn $10 Bonus if you are the first to top up.',
      },
    },
    auth: {
      title: 'Account',
