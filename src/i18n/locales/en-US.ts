  ...
  pages: {
    ...
    modelDetail: {
      ...
      history: {
        ...
        setExample: {
          title: 'Set as Playground example',
          hintPrefix: 'Add this generation\'s input / output as a Playground example for',
          hintSuffix: '.',
          save: 'Save example',
          formatJson: 'Format JSON',
          invalidModel: 'Invalid model format. Expected {base_model}/{capability}.',
          offeringNotFound: 'Offering not found: {model}',
          loadError: 'Failed to load offering',
          ...
          fields: {
            ...
            input: 'Input presets *',
            outputUrl: 'Output URL (result.output_url)',
            thumbnailUrl: 'Thumbnail URL (thumbnail_url)',
            sortOrder: 'Sort order',
          },
          placeholders: {
            id: 'e.g. cinematic-ocean',
            outputUrl: 'From generation result.output_url',
            thumbnailUrl: 'Optional',
          },
          validation: {
            missingId: 'Example ID is required',
            invalidId: 'ID must be lowercase letters, digits, or hyphens, starting with a letter or digit',
            duplicateId: 'ID “{id}” already exists',
            missingTitleEn: 'English title (en-US) is required',
            invalidInputObject: 'input must be a JSON object',
            invalidInputJson: 'input JSON is invalid',
            invalidOutputUrl: 'output_url must be an http(s) URL',
            invalidThumbnailUrl: 'thumbnail_url must be an http(s) URL',
          },
        },
      },
      generation: {
