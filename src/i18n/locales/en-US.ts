export default {
  ...
  pages: {
    ...
    billing: {
      ...
      bonusSplitHint: 'Cash {cash} · Bonus {bonus}',
      bonusExpires: 'Expires in {days}d {hours}h',
      bonusExpired: 'Expired',
      bonusSources: {
        seed_bonus: 'Seed Creator bonus',
    ...
    seedCreator: {
      ...
      lead: 'The first {seedCap} creators who pass X and Discord review get {seedBonus} Bonus and unlock exclusive invite rewards.',
      benefit:
        'The first {seedCap} verified users receive {seedBonus} Bonus. The first friend who tops up ≥ {minDeposit} in a single payment within {depositWindow} unlocks {inviteeReward} Bonus for the Winner and {inviterReward} Bonus for the inviter.',
      join: 'Join now',
      ...
      landing: {
        ...
        bonusRule: 'First {seedCap} to pass review',
        finePrint:
          'Bonus cannot be withdrawn or refunded. Valid for {bonusTtl} after claim, and no later than campaign end.',
        steps: {
          social: 'Submit X / Discord',
          review: 'Await manual review',
          invite: 'Share your invite link',
          reward: 'First friend qualifies: Winner +{inviteeReward}, inviter +{inviterReward}',
        },
        rulesTitle: 'Program rules',
        rules: {
          seed: 'The first {seedCap} creators who pass X and Discord review become Seed Creators and receive {seedBonus} Bonus.',
          inviteQuota: 'Each Seed Creator can invite many friends, but only has one invite reward (one Winner).',
          winner: 'Winner requirement: invitee completes a first single top-up ≥ {minDeposit} within {depositWindow} of signup.',
      ...
      steps: {
        ...
        bonus: 'Get {seedBonus} Bonus when approved',
        invite: 'Share your invite link',
        winner: 'First qualifying friend: Winner +{inviteeReward}, inviter +{inviterReward}',
      },
      campaign: {
        spots: 'Approved / cap',
      ...
      status: {
        submitted: 'Under review. You will receive {seedBonus} Bonus and an invite link if approved.',
        rejected: 'Not approved. You can update your details and submit again.',
        ended: 'This campaign has ended. The page is read-only.',
        noCampaign: 'No active campaign',
        noCampaignHint: 'There is no Seed Creator campaign to join right now.',
      },
      empty: {
        eyebrow: 'SEED CREATOR',
        title: 'No active campaign',
        lead: 'There is no Seed Creator campaign running right now. The next round will be announced here when it opens.',
        cardTitle: 'Stay tuned for the next round',
        cardBody: 'You can keep creating on Varo.cloud. We will notify you when the campaign opens.',
        backHome: 'Back to home',
      },
      ended: {
        eyebrow: 'SEED CREATOR PROGRAM',
        title: 'This campaign has ended',
        lead: 'Campaign data remains visible, but applications and new invite bindings are closed.',
        cardTitle: 'Campaign ended',
        finalRank: 'Final rank #{rank}',
        creatorBonusClaimed: 'Creator Bonus {seedBonus} claimed',
        inviteRewardClaimed: 'Invite reward {inviterReward} claimed',
      ...
      pending: {
        ...
        lead: 'Your details were submitted successfully. Our team is reviewing them, and the result will appear here.',
        statusLabel: 'Under review',
        submittedAt: 'Submitted at {time}',
        submittedAtUnknown: 'Submitted, waiting for review',
        profileLabel: 'Submitted details',
        profileEmpty: '—',
        update: 'Update details',
        updateHint: 'Updating will send your application back into the review queue.',
      },
      rejected: {
        eyebrow: 'APPLICATION STATUS',
        title: "We couldn't verify your profile",
        lead: 'Please check your profile links or identity details and submit again. You can still re-apply while the campaign is open.',
        cardTitle: 'Application not approved',
        reason: 'Reason: {reason}',
        reasonFallback: 'Your details could not be verified. Please check your links and identity information, then submit again.',
        resubmit: 'Resubmit',
        later: 'Later',
      },
      form: {
        eyebrow: 'APPLICATION',
        title: 'Apply to become a Seed Creator',
        updateTitle: 'Update your application',
        lead: 'Fill in at least one of X or Discord. Details are only used for identity review, and you can update them before approval.',
        twitterUsername: 'Twitter / X username',
        twitterUrl: 'Twitter / X profile URL',
        discordUsername: 'Discord username',
        discordUserId: 'Discord User ID',
        placeholderTwitterUsername: "{'@'}yourname",
        placeholderTwitterUrl: 'https://x.com/yourname',
        placeholderDiscordUsername: 'creator_name',
        placeholderDiscordUserId: '123456789012345678',
        confirm: 'I confirm the details above are mine and agree to use them for campaign review.',
        finePrint: 'Provide at least one complete platform profile',
        submit: 'Submit application',
        update: 'Update and submit',
        tipsTitle: 'Review tips',
        tips: [
          'Profiles must be publicly accessible',
          'Username and profile URL should match',
          'Usually completed within 1–2 business days',
        ],
      },
      approved: {
        eyebrow: 'CREATOR DASHBOARD',
        title: 'Welcome, Seed Creator #{rank}',
        titleFallback: 'Welcome, Seed Creator',
        lead: 'Your exclusive invite is live. The first friend who completes a single top-up ≥ {minDeposit} within {depositWindow} becomes the Winner.',
        rankLabel: 'Rank',
        rankValue: '#{rank}',
        bonusLabel: 'Creator Bonus',
        bonusClaimed: '{seedBonus} · Claimed',
        invitedLabel: 'Invited',
        invitedCount: '{count} people',
        winnerLabel: 'Winner reward',
        inviteLink: 'Exclusive invite link',
        copy: 'Copy link',
        copied: 'Invite link copied',
        copyFailed: 'Could not copy. Please copy it manually.',
        rewardWaiting: 'Waiting for first success',
      ...
      invitations: {
        ...
        yes: 'Yes',
        no: 'No',
        deadlineLeft: '{days}d {hours}h',
        deadlineHoursOnly: '{hours}h',
      ...
      bonus: {
        title: 'Your Bonus',
        hint: 'Bonus cannot be withdrawn or refunded, and expires automatically.',
        empty: 'No Bonus yet.',
        expired: 'Expired',
        expiresIn: 'Expires in {days}d {hours}h',
        goBilling: 'View billing / top up',
        source: {
          seed_bonus: 'Seed Creator bonus',
          inviter_reward: 'Inviter reward',
          invitee_reward: 'Invitee reward',
    ...
    invite: {
      ...
      title: 'You’re joining through a friend',
      lead: 'Sign up and complete a first single top-up of ≥ {minDeposit} within {depositWindow} for a chance to become the only Winner.',
      steps: {
        register: 'Register on Varo.cloud',
        bind: 'Auto-bind invitation',
        topup: 'Top up ≥ {minDeposit} within {depositWindow}',
        reward: 'Winner +{inviteeReward}, inviter +{inviterReward}',
      },
      loginHint: 'Invite code {code} will be bound automatically after you sign in.',
      login: 'Sign in to continue',
      bindingEyebrow: 'Connecting Invitation',
      bindingTitle: 'Binding your invitation',
      bindingLead: 'Please wait while we verify the invitation.',
      bindingStatus: 'Binding invitation…',
      bindingHint: 'Please keep this page open — it usually only takes a few seconds.',
      waitingEyebrow: 'Invitation Connected',
      waitingTitle: 'Your invitation is active',
      waitingLead:
        'Complete a first single top-up before the countdown ends. Split top-ups do not count.',
      countdownLabel: 'Time remaining',
      countdownValue: '{days}d {clock}',
      countdownExpired: 'Ended',
      countdownUnavailable: '—',
      topupLabel: 'Single top-up amount',
      topupAmount: '≥ {minDeposit}',
      waitingMeta: 'Inviter: {inviter} · Bound at {time}',
      waitingMetaInviterOnly: 'Inviter: {inviter}',
      waitingMetaBoundOnly: 'Bound at {time}',
      viewRules: 'View rules',
      rulesTitle: 'Campaign rules',
      waitingRules: {
        window: 'After binding, complete a first single top-up of ≥ {minDeposit} within {depositWindow}.',
        singlePayment: 'Split top-ups do not count — one payment must meet the threshold.',
        winnerSlot: 'Each inviter has only one Winner slot, awarded to the first qualifier.',
        reward: 'If you become the Winner, you receive {inviteeReward} Bonus and your inviter receives {inviterReward} Bonus.',
        bonus: 'Bonus is non-withdrawable and non-refundable; valid for {bonusTtl} after claim.',
      },
      winnerEyebrow: 'Reward Unlocked',
      winnerTitle: 'You’re the Winner!',
      winnerLead:
        'You’re the first user to meet the requirements on this invite link. The reward has been added to your Bonus balance.',
      winnerStatus: '+{amount} Bonus credited',
      winnerHint: 'Your inviter also received +{amount} Bonus. The reward expires in {days} days.',
      viewBalance: 'View balance',
      startCreate: 'Start creating',
      noRewardEyebrow: 'Condition Completed',
      noRewardTitle: 'Completed, but the reward is claimed',
      noRewardLead:
        'You met the top-up requirement, but the only {inviteeReward} slot for this invite was already claimed by an earlier qualifier.',
      ...
      bindError: 'Could not bind this invite. Please try again.',
      errorEyebrow: 'Invitation Error',
      errorTitle: 'We couldn’t bind this invitation',
      errorLead: 'Please resolve the issue below and try again.',
      errorStatus: 'Invitation unavailable',
      errorHint:
        'Possible reasons: invalid invite code, self-invite, campaign closed, or your account has already topped up.',
