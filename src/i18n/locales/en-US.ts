export default {
  ...
  pages: {
    ...
    seedCreator: {
      ...
      approved: {
        title: 'You are a Varo Seed Creator',
        rank: 'Rank #{rank}',
        seedBonus: '$20 Bonus',
        ...
        rewardWaiting: 'Waiting for the first successful invite',
        rewardClaimed: 'Invite reward claimed',
        rewardExpired: 'Invite reward expired',
      },
      invitations: {
        title: 'Invitations',
        ...
        yes: 'Yes',
        no: 'No',
        deadlineLeft: '{days}d {hours}h left',
