export default {
  ...
  pages: {
    ...
    invite: {
      eyebrow: 'Referral',
      title: 'You are joining Varo through a friend’s invite',
      lead: 'After binding, complete a first single top-up of ≥ $10 within 3 days. If you are the first to qualify for this inviter, you both receive $10 Bonus.',
      steps: {
        register: 'Sign up / log in',
        requirements: 'Complete campaign requirements',
        topup: 'First single top-up ≥ $10 within 3 days',
      },
      loginToJoin: 'Sign in to bind the invite. Bind before you top up.',
      login: 'Sign in and bind',
      binding: 'Binding your invite…',
      waitingTitle: 'Invite bound',
      waitingBody:
        'Complete a first single top-up of ≥ $10 within 3 days of signup. Only the first qualifying friend of this Seed Creator becomes the Winner.',
      waitingHint:
        'If you already topped up and no Bonus arrived, another invitee may have claimed the reward first.',
      winnerTitle: 'Congratulations!',
      winnerBody: 'You are the first successful invitee.',
      winnerBonus: 'Your Bonus {amount}',
      inviterAlso: 'Your inviter also received $10 Bonus.',
      ...
      errorTitle: 'Unable to bind invite',
      seo: {
