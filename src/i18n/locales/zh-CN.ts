  ...
  pages: {
    ...
    modelDetail: {
      ...
      history: {
        ...
        setExample: {
          title: '设为 Playground 示例',
          hintPrefix: '将当前生成的 input / output 添加为',
          hintSuffix: '的 Playground 示例。',
          save: '保存示例',
          formatJson: '格式化 JSON',
          invalidModel: '模型格式无效，须为 {base_model}/{capability}',
          offeringNotFound: '未找到 offering：{model}',
          loadError: '加载 offering 失败',
          saveError: '保存失败',
          added: '已添加示例到 {model}',
          updated: '已更新示例「{id}」',
          ...
          fields: {
            ...
            description: '说明',
            input: 'Input 预设值 *',
            outputUrl: '输出 URL (result.output_url)',
            thumbnailUrl: '缩略图 URL (thumbnail_url)',
            sortOrder: '排序 (sort_order)',
          },
          placeholders: {
            id: '如 cinematic-ocean',
            outputUrl: '来自 generation result.output_url',
            thumbnailUrl: '可选',
          },
          validation: {
            missingId: '请填写示例 ID',
            invalidId: 'ID 格式无效，须为小写字母/数字/连字符，且以字母或数字开头',
            duplicateId: 'ID「{id}」已存在',
            missingTitleEn: '请填写英文标题 (en-US)',
            invalidInputObject: 'input 必须是 JSON 对象',
            invalidInputJson: 'input JSON 格式无效',
            invalidOutputUrl: 'output_url 须为 http(s) URL',
            invalidThumbnailUrl: 'thumbnail_url 须为 http(s) URL',
          },
        },
      },
      generation: {
