export default {
  ...
  pages: {
    ...
    invite: {
      eyebrow: '邀请活动',
      title: '你正在通过好友邀请参加 Varo 活动',
      lead: '绑定邀请关系后，请在 3 天内完成首次单笔充值 ≥ $10。若你是该邀请人的首位达标好友，双方各得 $10 Bonus。',
      steps: {
        register: '注册 / 登录',
        requirements: '完成活动要求',
        topup: '3 天内首次单笔充值 ≥ $10',
      },
      loginToJoin: '登录后将自动绑定邀请关系。请先绑定再充值。',
      login: '登录并绑定',
      binding: '正在绑定邀请关系…',
      waitingTitle: '邀请已绑定',
      waitingBody: '请在注册后 3 天内完成首次单笔充值 ≥ $10。只有该邀请人的第一位达标好友会成为 Winner。',
      waitingHint: '若已完成首充仍未到账，可能该邀请奖励已被其他用户先触发。',
      winnerTitle: '恭喜，你是首位成功被邀请人',
      winnerBody: '你已获得邀请 Bonus。',
      winnerBonus: 'Your Bonus {amount}',
      inviterAlso: '邀请人同时获得 $10 Bonus。',
      viewBonus: '查看 Bonus',
      goTopup: '去充值',
      goActivity: '查看活动页',
      invalid: '邀请码无效。',
