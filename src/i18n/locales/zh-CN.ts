export default {
  ...
  pages: {
    ...
    billing: {
      ...
      bonusSectionTitle: 'Bonus 明细',
      bonusSectionHint: 'Bonus 不可提现、不可退款，优先于 Cash 消耗，到期后自动失效。',
      bonusEmpty: '暂无 Bonus。',
      bonusRemaining: '剩余 {amount}',
      bonusGranted: '发放 {amount}',
    ...
    seedCreator: {
      ...
      lead: '前 30 名通过 X 与 Discord 审核的创作者可获得 $20 Bonus，并解锁专属邀请奖励。',
      benefit: '前 30 名完成验证的用户获得 $20 Bonus；首位在 3 天内完成单笔充值 ≥ $10 的好友，双方再各得 $10 Bonus。',
      join: '立即参加',
      viewRules: '查看活动规则',
      ...
      landing: {
        ...
        bonusRule: '前 30 名完成审核',
        finePrint: 'Bonus 不可提现、不可退款；领取后 14 天内有效，且不晚于活动结束。',
        steps: {
          social: '提交 X / Discord',
          review: '等待人工审核',
          invite: '分享邀请链接',
          reward: '首位好友达标，双方各 +$10',
        },
        rulesTitle: '活动规则',
        rules: [
          '前 30 名完成 X 与 Discord 审核即可成为 Seed Creator，获得 $20 Bonus。',
          'Seed Creator 可邀请多人，但每位 Seed Creator 仅有 1 次邀请奖励机会（1 个 Winner）。',
          'Winner 条件：被邀请人注册后 3 天内，完成首次单笔充值 ≥ $10。',
          'Winner 与邀请人各得 $10 Bonus。',
          'Bonus 不可提现、不可退款；领取后 14 天内有效，且不晚于活动结束。',
        ],
      },
      steps: {
        register: '注册 / 登录 Varo',
        ...
        review: '人工审核',
        bonus: '通过后获得 $20 Bonus',
        invite: '分享专属邀请链接',
        winner: '首位达标好友触发双方各 $10',
      },
      campaign: {
        spots: '已通过 / 名额',
        remaining: '剩余名额',
      ...
      status: {
        submitted: '审核中，通过后将发放 $20 Bonus 并生成邀请链接。',
      ...
      ended: {
        ...
        cardTitle: '活动已结束',
        finalRank: '最终排名 #{rank}',
        creatorBonusClaimed: 'Creator Bonus $20 已领取',
        inviteRewardClaimed: '邀请奖励 $10 已领取',
      ...
      approved: {
        ...
        lead: '你的专属邀请已开启。首位在 3 天内完成单笔充值 ≥ $10 的好友将成为 Winner。',
        rankLabel: '排名',
        rankValue: '#{rank}',
      ...
      seo: {
        ...
        description: '成为 Varo Seed Creator：完成社交验证获得 $20 Bonus，邀请好友首充双方再各得 $10。',
      },
    },
    invite: {
      eyebrow: 'Friend Invitation',
      title: '你正在通过好友邀请加入',
      lead: '完成注册，并在 3 天内首次单笔充值 ≥ $10，即有机会成为唯一 Winner。',
      steps: {
        register: '注册 Varo.cloud',
        bind: '自动绑定邀请',
        topup: '3 天内充值 ≥ $10',
        reward: 'Winner 双方各 +$10',
      },
      ...
      rulesTitle: '活动规则',
      waitingRules: [
        '绑定邀请后，请在 3 天内完成首次单笔充值 ≥ $10。',
        '拆分充值不计入活动条件，必须以单笔达标。',
        '每位邀请人仅有 1 个 Winner 名额，以首位达标者为准。',
        '若你成为 Winner，你与邀请人各得 $10 Bonus。',
        'Bonus 不可提现、不可退款；领取后 14 天内有效。',
      ],
      ...
      noRewardLead: '你已完成充值条件，但该邀请的唯一 $10 名额已由更早达标的用户获得。',
      ...
      seo: {
        ...
        description: '通过 Seed Creator 邀请加入 Varo，3 天内完成首充即有机会获得 $10 Bonus。',
      },
    },
    auth: {
      title: '账户',
