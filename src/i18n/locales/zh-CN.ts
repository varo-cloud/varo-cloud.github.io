export default {
  ...
  pages: {
    ...
    billing: {
      ...
      cashBalance: '现金余额',
      bonusBalance: 'Bonus 余额',
      totalBalance: '可用总额',
      bonusSplitHint: 'Cash {cash} · Bonus {bonus}',
      bonusExpires: '剩余 {days} 天 {hours} 小时到期',
      bonusExpired: '已过期',
      bonusSources: {
        seed_bonus: 'Seed Creator 奖励',
        inviter_reward: '邀请奖励',
    ...
    seedCreator: {
      ...
      lead: '前 {seedCap} 名通过 X 与 Discord 审核的创作者可获得 {seedBonus} Bonus，并解锁专属邀请奖励。',
      benefit:
        '前 {seedCap} 名完成验证的用户获得 {seedBonus} Bonus；首位在 {depositWindow}内完成单笔充值 ≥ {minDeposit} 的好友，Winner 获得 {inviteeReward} Bonus，邀请人获得 {inviterReward} Bonus。',
      join: '立即参加',
      viewRules: '查看活动规则',
      loginToJoin: '登录后即可提交社交账号，申请成为 Seed Creator。',
      retry: '重试',
      loadError: '活动信息加载失败。',
      submitSuccess: '已提交，等待审核。',
      submitError: '提交失败，请重试。',
      landing: {
        bonusLabel: 'EARLY CREATOR BONUS',
        bonusRule: '前 {seedCap} 名完成审核',
        finePrint: 'Bonus 不可提现、不可退款；领取后 {bonusTtl}内有效，且不晚于活动结束。',
        steps: {
          social: '提交 X / Discord',
          review: '等待人工审核',
          invite: '分享邀请链接',
          reward: '首位好友达标：Winner +{inviteeReward}，邀请人 +{inviterReward}',
        },
        rulesTitle: '活动规则',
        rules: {
          seed: '前 {seedCap} 名完成 X 与 Discord 审核即可成为 Seed Creator，获得 {seedBonus} Bonus。',
          inviteQuota: 'Seed Creator 可邀请多人，但每位 Seed Creator 仅有 1 次邀请奖励机会（1 个 Winner）。',
          winner: 'Winner 条件：被邀请人注册后 {depositWindow}内，完成首次单笔充值 ≥ {minDeposit}。',
      ...
      steps: {
        register: '注册 / 登录 Varo',
        social: '提交 Twitter/X 与 Discord',
        review: '人工审核',
        bonus: '通过后获得 {seedBonus} Bonus',
        invite: '分享专属邀请链接',
        winner: '首位达标好友：Winner +{inviteeReward}，邀请人 +{inviterReward}',
      },
      campaign: {
        spots: '已通过 / 名额',
        remaining: '剩余名额',
      ...
      status: {
        submitted: '审核中，通过后将发放 {seedBonus} Bonus 并生成邀请链接。',
        rejected: '审核未通过，你可以更新资料后再次提交。',
        ended: '活动已结束，页面仅供查看。',
        noCampaign: '暂无进行中的活动',
        noCampaignHint: '当前没有可参加的 Seed Creator 活动。',
      },
      empty: {
        eyebrow: 'SEED CREATOR',
        title: 'No active campaign',
        lead: '当前没有正在进行的 Seed Creator 活动。新一期开放后会在此页面公布。',
        cardTitle: '下一期，敬请期待',
        cardBody: '你可以继续使用 Varo.cloud 创建内容，活动开放时我们会发送通知。',
        backHome: '返回首页',
      },
      ended: {
        eyebrow: 'SEED CREATOR PROGRAM',
        title: 'This campaign has ended',
        lead: '活动数据仍可查看，但不再接受报名或新的邀请绑定。',
        cardTitle: '活动已结束',
        finalRank: '最终排名 #{rank}',
        creatorBonusClaimed: 'Creator Bonus {seedBonus} 已领取',
        inviteRewardClaimed: '邀请奖励 {inviterReward} 已领取',
      ...
      pending: {
        ...
        lead: '资料已成功提交。团队正在进行人工审核，审核结果会显示在这里。',
        statusLabel: '审核中',
        submittedAt: '提交于 {time}',
        submittedAtUnknown: '已提交，等待审核',
        profileLabel: '已提交资料',
        profileEmpty: '—',
        update: '更新资料',
        updateHint: '更新后会重新进入审核队列。',
      },
      rejected: {
        eyebrow: 'APPLICATION STATUS',
        title: "We couldn't verify your profile",
        lead: '请检查账号链接或身份信息后再次提交。你仍可在活动期间重新申请。',
        cardTitle: '本次审核未通过',
        reason: '原因：{reason}',
        reasonFallback: '资料未通过核验，请核对链接与身份信息后重新提交。',
        resubmit: '重新提交',
        later: '暂后处理',
      },
      form: {
        ...
        updateTitle: '更新社交资料',
        lead: 'X 或 Discord 至少填写一项。资料仅用于身份核验，你可以在审核完成前更新。',
        ...
        confirm: '我确认以上资料属于本人，并同意用于活动审核。',
        finePrint: '至少填写一组完整的平台资料',
        submit: '提交申请',
        update: '更新并提交',
        tipsTitle: '审核提示',
        tips: ['主页需可公开访问', '昵称与链接应匹配', '通常在 1–2 个工作日完成'],
      },
      approved: {
        eyebrow: 'CREATOR DASHBOARD',
        title: 'Welcome, Seed Creator #{rank}',
        titleFallback: 'Welcome, Seed Creator',
        lead: '你的专属邀请已开启。首位在 {depositWindow}内完成单笔充值 ≥ {minDeposit} 的好友将成为 Winner。',
        rankLabel: '排名',
        rankValue: '#{rank}',
        bonusLabel: 'Creator Bonus',
        bonusClaimed: '{seedBonus} · 已领取',
        invitedLabel: '已邀请',
        invitedCount: '{count} 人',
        winnerLabel: 'Winner 奖励',
        inviteLink: '专属邀请链接',
        copy: '复制链接',
        copied: '已复制邀请链接',
        copyFailed: '复制失败，请手动复制。',
        rewardWaiting: '等待首位成功邀请',
        rewardClaimed: '奖励已领取',
        rewardExpired: '奖励已失效',
      ...
      invitations: {
        ...
        yes: '是',
        no: '否',
        deadlineLeft: '{days}天 {hours}小时',
        deadlineHoursOnly: '{hours}小时',
      ...
      bonus: {
        title: '我的 Bonus',
        hint: 'Bonus 不可提现、不可退款，到期后自动失效。',
        empty: '暂无 Bonus。',
        expired: '已过期',
        expiresIn: '{days} 天 {hours} 小时后到期',
        goBilling: '去账单查看 / 充值',
        source: {
          seed_bonus: 'Seed Creator 奖励',
          inviter_reward: '邀请奖励',
    ...
    invite: {
      ...
      title: '你正在通过好友邀请加入',
      lead: '完成注册，并在 {depositWindow}内首次单笔充值 ≥ {minDeposit}，即有机会成为唯一 Winner。',
      steps: {
        register: '注册 Varo.cloud',
        bind: '自动绑定邀请',
        topup: '{depositWindow}内充值 ≥ {minDeposit}',
        reward: 'Winner +{inviteeReward}，邀请人 +{inviterReward}',
      },
      loginHint: '邀请码 {code} 将在登录后自动绑定。',
      login: '登录并继续',
      bindingEyebrow: 'Connecting Invitation',
      bindingTitle: '正在绑定邀请',
      bindingLead: '请稍候，我们正在验证邀请关系。',
      bindingStatus: '正在绑定邀请…',
      bindingHint: '请不要关闭页面，通常只需要几秒钟。',
      waitingEyebrow: 'Invitation Connected',
      waitingTitle: '邀请已生效',
      waitingLead: '请在倒计时结束前完成首次单笔充值，拆分充值不计入活动条件。',
      countdownLabel: '剩余有效时间',
      countdownValue: '{days} 天 {clock}',
      countdownExpired: '已结束',
      countdownUnavailable: '—',
      topupLabel: '单笔充值金额',
      topupAmount: '≥ {minDeposit}',
      waitingMeta: '邀请人：{inviter} · 绑定于 {time}',
      waitingMetaInviterOnly: '邀请人：{inviter}',
      waitingMetaBoundOnly: '绑定于 {time}',
      viewRules: '查看规则',
      rulesTitle: '活动规则',
      waitingRules: {
        window: '绑定邀请后，请在 {depositWindow}内完成首次单笔充值 ≥ {minDeposit}。',
        singlePayment: '拆分充值不计入活动条件，必须以单笔达标。',
        winnerSlot: '每位邀请人仅有 1 个 Winner 名额，以首位达标者为准。',
        reward: '若你成为 Winner，你将获得 {inviteeReward} Bonus，邀请人获得 {inviterReward} Bonus。',
        bonus: 'Bonus 不可提现、不可退款；领取后 {bonusTtl}内有效。',
      },
      winnerEyebrow: 'Reward Unlocked',
      winnerTitle: '你是 Winner！',
      winnerLead: '你是该邀请链接下首位完成条件的用户，奖励已发放至 Bonus 余额。',
      winnerStatus: '+{amount} Bonus 已到账',
      winnerHint: '邀请人也已获得 +{amount} Bonus。奖励将在 {days} 天后到期。',
      viewBalance: '查看余额',
      startCreate: '开始创作',
      noRewardEyebrow: 'Condition Completed',
      noRewardTitle: '已完成，但奖励名额已满',
      ...
      errorTitle: '无法绑定此邀请',
      errorLead: '请根据具体错误处理后重试。',
      errorStatus: '邀请码不可用',
      errorHint:
        '可能原因：邀请码无效、自己邀请自己、活动已关闭，或你的账户已经完成过充值。',
      errorCode: '错误代码：{code}',
      backHome: '返回首页',
      contactSupport: '联系支持',
