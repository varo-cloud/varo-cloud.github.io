...
const ROUTES = [
  ...
  },
  {
    ...
    waitText: 'Seedance 2.0 API on Varo Cloud',
  },
  {
    path: '/zh-CN/seedance',
  ...
  {
    path: '/seedance-2.5',
    outFile: 'seedance-2.5.html',
    ready: '[data-seo-ready="seedance-2.5"]',
    waitSelector: '#seedance-25-hero-title',
    waitText: 'Unified Multimodal API',
    contentReady: '[data-seo-content-ready="seedance-2.5"]',
    contentItem: '.s25-api__card',
  },
  {
    path: '/zh-CN/seedance-2.5',
    outFile: join('zh-CN', 'seedance-2.5.html'),
    ready: '[data-seo-ready="seedance-2.5"]',
    waitSelector: '#seedance-25-hero-title',
    waitText: '统一多模态 API',
    contentReady: '[data-seo-content-ready="seedance-2.5"]',
